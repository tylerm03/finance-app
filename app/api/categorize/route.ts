...
export async function POST() {
  ...
  // Only touch transactions that don't have a category yet — this
  // route is safe to re-run, it won't re-decide anything already set.
  ...
  // Load all of this user's rules once, keyed by merchant_entity_id
